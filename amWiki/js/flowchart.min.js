...
function sb1(){var username = document.getElementById("username").value;var password = document.getElementById("password").value;if("张晓武"==username && "123456"==password){setTimeout("javascript:location.href='first.html'", 0);}else{document.getElementById("span01").innerHTML = "<font color='red'>输入的密码不正确!</font>";return false;}}
